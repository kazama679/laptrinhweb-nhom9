<template>
    ...
    <div class="bg-red-400 mt-12 p-16 px-32 text-white flex flex-col justify-center items-center self-end">
    ...
    <!-- Right Card -->
    <div class="bg-yellow-500 mb-12 p-16 px-32 text-white flex flex-col justify-center items-center">
