<template>
  <div>
    ...
    <div className="flex justify-center items-center mt-32">
      <div
        className="w-3/4 flex p-6 border border-gray-300 rounded-lg bg-white"
      >
        <div className="w-1/2">
      ...
      <div class="flex flex-wrap justify-between gap-5 mt-5">
        ...
        >
          ...
          <div class="p-4">
            ...
            <p class="text-red-500 mt-2 font-bold">
    ...
    <div className="container mx-auto mt-8 px-40">
      ...
      <div className="flex items-center space-x-4 my-4">
        <button
          className="border border-red-500 px-4 py-2 rounded-full text-red-500"
        >
          Đã mua hàng
        </button>
        <button
        ...
        <div className="flex space-x-2">
          <button
            key="{star}"
            className="border px-4 py-2 rounded-full border-red-500 text-red-500"
          >
            {star} sao
          </button>
        </div>
      ...
      >
        <div className="flex items-start gap-4 mb-6">
          ...
          <div className="w-full">
            ...
            <p className="bg-gray-100 p-3 rounded-lg mt-2">{review.comment}</p>
        ...
        <div key="{item.id}" className="flex items-start gap-4 mb-6 ml-16">
          ...
          <div className="w-full">
            ...
            <p className="bg-gray-100 p-3 rounded-lg mt-2">{item.comment}</p>
            <div className="flex justify-end mt-2">
              <button
                className="flex items-center text-red-500 hover:text-red-700 text-sm"
              >
    ...
    >
      <div
        className="bg-white rounded-lg shadow-lg w-[600px] max-w-full p-6 relative"
      >
        <button
          onClick="{build}"
        ...
        <div className="flex justify-between mb-4">
          <div key="{star}" className="text-center cursor-pointer">
            ...
            <p className="text-sm mt-1">
              {star === 5 ? "Tuyệt vời" : star === 1 ? "Rất tệ" : ""}
            </p>
          </div>
        </div>
        <textarea
        ...
        />
        <button
          className="w-full mt-6 bg-red-500 text-white text-lg font-bold py-3 rounded-md hover:bg-red-600"
        >
          Gửi Đánh Giá
        </button>
      </div>
    ...
    <div
      v-if="isShowMessager"
      className="fixed inset-0 flex items-center justify-center z-50 border border-black"
    >
      <div
        className="bg-white p-6 shadow-2xl rounded-lg z-50 flex flex-col items-center justify-center text-center"
      >
